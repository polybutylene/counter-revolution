...
const PLACEHOLDER_TESTIMONIALS: TestimonialItem[] = [
  { _id: "1", name: "Sarah M.", quote: "Stratum Co. transformed our kitchen completely. The quartz countertops are absolutely stunning and the installation was done in just one day. Highly recommend!", rating: 5, projectType: "Kitchen Countertops", city: "Panama City" },
  { _id: "2", name: "David & Lisa R.", quote: "We shopped around for months and nobody came close to the quality and pricing Stratum Co. offered. Our granite countertops exceeded every expectation.", rating: 5, projectType: "Kitchen Countertops", city: "Lynn Haven" },
  { _id: "3", name: "Mike T.", quote: "As a general contractor, I need reliable partners. Stratum Co. delivers on time, every time. Their fabrication quality is the best in Bay County.", rating: 5, projectType: "Commercial", city: "Panama City Beach" },
