...
const PROJECTS_DATA: Record<string, ProjectData> = {
  "modern-kitchen-transformation": {
    ...
    customerTestimonial: {
      name: "Sarah M.",
      quote:
        "Stratum Co. exceeded our expectations. The granite is gorgeous and the installation was flawless. They were professional, on time, and left everything spotless.",
      rating: 5,
    },
  },
  ...
  "elegant-marble-master-bath": {
    ...
    customerTestimonial: {
      name: "David R.",
      quote: "The marble is absolutely breathtaking. Yes, it requires some care, but it's worth it. Stratum Co. guided us through the whole process.",
      rating: 5,
    },
  },
