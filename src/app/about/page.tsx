...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about Stratum Co. — locally owned countertop fabrication and installation serving Bay County, FL. Our story, team, and commitment to quality.",
};
...
const TEAM = [
  { name: "Owner", role: "Founder & Lead Fabricator", bio: "With years of experience in the stone industry, our founder brought Stratum Co. to Bay County with a vision: make premium countertops accessible to every homeowner." },
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <AnimateInView>
            ...
            <div className="mt-6 space-y-4 text-muted-foreground">
              <p>
                Stratum Co. was born from a straightforward idea: Bay County homeowners
              ...
              <p>
                When we acquired Stratum Co., we saw an opportunity to bring a fresh
