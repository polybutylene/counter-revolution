...
const PLACEHOLDER_TESTIMONIALS = [
  { _id: "1", name: "Sarah M.", quote: "Stratum Co. transformed our kitchen completely. The quartz countertops are absolutely stunning and the installation was done in just one day.", rating: 5, projectType: "Kitchen Countertops", city: "" },
  ...
  { _id: "3", name: "Mike T.", quote: "As a general contractor, I need reliable partners. Stratum Co. delivers on time, every time. Fabrication quality is the best in Bay County.", rating: 5, projectType: "Commercial", city: "" },
];
...
> = {
  "panama-city": {
    ...
    intro: [
      "Panama City is the vibrant heart of Bay County, home to the historic St. Andrews waterfront, the marina district, and neighborhoods like Millville and Cove. Stratum Co. has been serving Panama City homeowners and businesses with premium granite, quartz, marble, and quartzite fabrication for years.",
  ...
  "lynn-haven": {
    ...
    intro: [
      ...
      "Stratum Co. serves Lynn Haven from our central Bay County location. We're your neighbors—quick to schedule measurements, flexible on material selection, and committed to clean, professional installations. Many of our happiest customers are right here in Lynn Haven.",
    ],
  ...
  springfield: {
    ...
    intro: [
      ...
      "Stratum Co. provides full-service countertop fabrication and installation throughout Springfield. From cozy bungalows to modern builds, we help you choose the right stone—granite, quartz, marble, or quartzite—and install it with precision. Free estimates and friendly, local service.",
    ],
  ...
  "mexico-beach": {
    ...
    intro: [
      ...
      "Stratum Co. extends our service area to Mexico Beach, bringing showroom-quality fabrication and installation to your doorstep. We help you choose stone that stands up to salt air, humidity, and the occasional storm—and we deliver with the same reliability you expect from a local team.",
    ],
          ...
          <AnimateInView className="mt-10">
            <div className="aspect-[16/9] overflow-hidden rounded-xl border border-warm-medium">
              <iframe
                ...
                title={`Stratum Co. service area - ${area.cityName}, FL`}
              />
            </div>
          </AnimateInView>
        </div>
