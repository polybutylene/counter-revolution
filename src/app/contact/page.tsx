...
export const metadata: Metadata = {
  ...
  description: "Request a free countertop estimate or ask a question. Call, email, or fill out our form. Countertop Revolution serves all of Bay County, FL.",
};
            ...
            <div className="lg:pl-8">
              <div className="rounded-xl border border-warm-medium bg-white p-6 shadow-sm">
                ...
                <ul className="mt-6 space-y-5">
                  ...
                  <li>
                    <a href="mailto:info@countertoprevolution.com" className="flex items-start gap-3 group">
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-warm-light text-navy group-hover:bg-gold/10 group-hover:text-gold">
                        <Mail className="h-5 w-5" />
                      </div>
                      <div>
                        <p className="text-sm font-semibold text-navy group-hover:text-gold">info@countertoprevolution.com</p>
              ...
              <div className="mt-6 overflow-hidden rounded-xl border border-warm-medium">
                <iframe
                  ...
                  title="Countertop Revolution location"
                />
              </div>
            </div>
          </div>
